...
import '../styles/SeriesInstancePage.scss';
...
class SeriesInstance extends React.Component {
    ...
    async componentDidMount() {
        ...
        let url =
            ...
            'series/' + // characters | comics | creators | events | series | stories
            id +
            ...
            .then((res) => {
                ...
                <div id="${id}">
                    ...
                    <section>
                        ...
                        <p><span style="font-weight: bold">Description</span>: ${res.data.results[0].description == null ? 'N/A' : res.data.results[0].description}</p>
                    </section>
                </div>
                `;
                document.querySelector(".Series-instance").innerHTML += htmlContent;
            });
    }
    ...
    render() {
        return (
            <div className='SeriesInstance-main'>
                <section className='Series-instance'>
                </section>
